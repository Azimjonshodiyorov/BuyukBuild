using BuyukBuild.Domain.Entities.ApiModels;
...
namespace BuyukBuild.Infrastructure.Extensions
{
    public static class QueryableExtensions
    {
        public static IQueryable<T> Filter<T>(this IQueryable<T> queryable , MetaQueryModel metaQueryModel)
        {
            var filterData = new 
            {
                PropertyName = metaQueryModel.FilterPropName, 
                Value = metaQueryModel.FilterPropValue 
            };
